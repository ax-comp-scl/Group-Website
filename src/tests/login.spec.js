...
test.describe('Página de Login', () => {
  ...
  test('deve exibir uma mensagem de erro contendo "Credenciais inválidas" em caso de erro no login', async ({
    page,
  }) => {
    await page.goto('/login')
  ...
  test('deve exibir uma mensagem de erro ao tentar enviar o formulário sem preencher os campos', async ({
    page,
  }) => {
    await page.goto('/login')
    ...
    const emailError = page.locator(
      'div[data-slot="error-message"]:has-text("Insira um E-mail válido")'
    )
  ...
  test('deve exibir uma mensagem de erro caso o e-mail seja preenchido de maneira inválida', async ({
    page,
  }) => {
    await page.goto('/login')
  ...
  test('deve exibir a senha ao clicar no botão do "olhinho"', async ({
    page,
  }) => {
    await page.goto('/login')
