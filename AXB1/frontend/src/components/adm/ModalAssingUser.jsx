                ...
                <div className="flex flex-col bg-[#d6d6d6]">
                    <div className="w-full flex bg-[#d6d6d6] items-center justify-between px-2 gap-2">
                        ...
                        <input 
                            ...
                            className=
                            "flex-1 bg-[#d6d6d6] focus:outline-none h-14 text-xl text-gray-600" />
                        <div>
                            <Kbd className="items-center text-center shadow-small rounded-small hidden md:block border-none px-2 py-1 font-semibold text-xs"><span>ESC</span></Kbd>
                        </div>
                    </div>
                    <Divider></Divider>
